...
%Avg = Average generation in last five years
   ...
   Cost_1 = [2 5 2.5]; 
     ...
     MDDL = [30 10 40];
     Hp = [30 40 120];
     z = dynamic_stage(Cost,Dem,E,Beta,V1,Rain,MDDL,FRL,Hp,t1,p,Avg);
     y = linear_stage(Day, Cost_1,Cost_imp,Demand,Hydro_cap, Thermal_cap,Hydro_avg,Ramp_Rate,Sol_E,n,t,Beta);
     %disp(z);
